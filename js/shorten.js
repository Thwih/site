/**
 * shorten.js – Module rút gọn link qua Worker (ẩn token)
 * Sử dụng API Gateway: https://thwihsite06.weylynofficial.workers.dev/
 * Cache lưu vào localStorage để tránh gọi lại nhiều lần
 */
...
function setCache(originalUrl, shortenedUrl) {
    ...
    try {
        ...
        // Bỏ qua lỗi storage (ví dụ: chế độ ẩn danh)
    }
}

// ===== GỌI WORKER ĐỂ RÚT GỌN 1 LẦN =====
...
export function createProgressPage(title = 'Đang tạo link...') {
    ...
    // Ghi nội dung HTML cho tab loading
